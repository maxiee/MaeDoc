...
**Maeiee 的终生数字系统** —— 一个技术 Geek 为自己打造的、可以伴随一生的生产力系统。核心理念：数据永恒（文件即数据库，借鉴 Obsidian）、能力流转（Emacs 式统一注册，代码生成多技术栈 SDK）、视图融合（跨技术栈 GUI 积木式组装）。一切皆未定，一切皆开放，这只是一个终生旅程的起点。
...
| 文档 | 说明 |
|------|------|
| [总愿景](./vision/overview.md) | Maeiee 的终生数字系统：从极客叙事出发，阐述「变与不变」的哲学、数据永恒、能力流转、视图融合 |
