...
| 深化 | AI 能力强化 | v0031-v0040 | 提示优化、交互改进、RAG 探索 |
...
### v0035-v0037: RAG 集成（探索阶段）

> **注意**：这是一个较大的改动，可能需要多个版本迭代
...
**Commit**: `feat: add vector indexing infrastructure`

---

**v0036: Skills 集成 RAG**

**目标**：让关键 Skills 使用检索结果。

**改动点**：
- `doc-content-fill` 在填充时参考已有文档
- `doc-iterate` 在修改时参考相关内容
- 自动检测并避免内容矛盾
...
**Commit**: `feat: integrate RAG into content filling`

---

**v0037: RAG 效果评估**

**目标**：评估 RAG 的实际效果，决定是否继续投入。
...
**Commit**: `docs: evaluate RAG effectiveness`
